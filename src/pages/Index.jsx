        ...
        <div className="container flex h-14 items-center">
          <div className="mr-4 hidden md:flex">
            ...
            <nav className="flex items-center space-x-6 text-sm font-medium">
              ...
              <a className="transition-colors hover:text-foreground/80 text-foreground/60" href="#contact">Contact Us</a>
            </nav>
          </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Find Contracts Nearby</h3>
              <p className="text-gray-500">Easily locate available contracts within your proximity.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <Users className="h-12 w-12 mb-4 text-blue-600" />
              <h3 className="text-xl font-bold mb-2">Join for Exclusive Benefits</h3>
              <p className="text-gray-500">Access exclusive contracts and opportunities.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <FileCheck className="h-12 w-12 mb-4 text-blue-600" />
              <h3 className="text-xl font-bold mb-2">Tender on Your Behalf</h3>
              <p className="text-gray-500">Let us handle the tendering process for you.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col p-6 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-4xl font-bold mb-6">$10<span className="text-base font-normal">/month</span></p>
            ...
            <div className="flex flex-col p-6 bg-white rounded-lg shadow-lg border-2 border-blue-600">
              <h3 className="text-2xl font-bold mb-4">Pro</h3>
              <p className="text-4xl font-bold mb-6">$20<span className="text-base font-normal">/month</span></p>
              <ul className="mb-6 space-y-2">
                <li className="flex items-center">
                  <DollarSign className="h-5 w-5 mr-2 text-green-500" />
              ...
              <Button className="mt-auto bg-blue-600 hover:bg-blue-700">Choose Plan</Button>
            </div>
            <div className="flex flex-col p-6 bg-white rounded-lg shadow-lg">
              ...
              <ul className="mb-6 space-y-2">
                <li className="flex items-center">
                  <DollarSign className="h-5 w-5 mr-2 text-green-500" />
                  Customized solutions for large fleets
                </li>
              </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-500">"Zeus Connect AI has revolutionized how I find and manage contracts. It's a game-changer for hauliers!"</p>
              </div>
            ))}
          </div>
        </div>
